...
class UsuarioService {
  ...
  async registrarCasal(dados: any) {
    try {
      const dadosBackend = {
  ...
  async atualizarPerfil(id: string, dados: any) {
    try {
      const dadosBackend = {
        nomeCompleto: dados.nomeCompleto,
        dataNascimento: dados.dataNascimento,
  ...
  async atualizarPerfilCasal(id: string, dados: any) {
    try {
      const dadosBackend = {
        nomeCompletoPessoa1: dados.nomeCompletoPessoa1,
        dataNascimentoPessoa1: dados.dataNascimentoPessoa1,
  ...
  async atualizarModoEscuro(id: string, modoEscuro: boolean) {
    try {
