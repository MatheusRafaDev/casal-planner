    ...
    public class RecuperarSenhaService : IRecuperarSenhaService
    {
        ...
        public async Task<RedefinirSenhaResponseDto> RedefinirSenhaAsync(string token, string novaSenha)
        {
            try
            {
                ...
                var updateBuilder = Builders<CasalPlanner.API.Models.Usuario>.Update;
                UpdateDefinition<CasalPlanner.API.Models.Usuario>? updateDefinition = null;
        ...
        private string ObterNomeUsuario(CasalPlanner.API.Models.Usuario usuario, string email)
        {
            if (usuario.TipoConta == TipoConta.Individual)
            {
        ...
        private string? ObterPessoaDoCasal(CasalPlanner.API.Models.Usuario usuario, string email)
        {
