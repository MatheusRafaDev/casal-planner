...
async function checkHorizontalScroll(page: Page, viewportName: string) {
  ...
  console.log(`[${viewportName}] document.scrollWidth: ${documentWidth}, window.innerWidth: ${windowWidth}, overflow: ${scrollWidth}px`);
  ...
  if (scrollWidth > 0) {
    ...
    console.log(`[${viewportName}] Elementos com overflow:`, JSON.stringify(overflowElements, null, 2));
  }
