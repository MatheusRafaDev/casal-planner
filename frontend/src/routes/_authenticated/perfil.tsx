              ...
              <Tabs defaultValue="p1">
                ...
                <TabsContent value="p1">
                  <PessoaForm
                    ...
                    bloquearEmailCpf
                    somenteLeitura={usuario.pessoaLogada !== 1}
                    onSave={async (dto) => {
                ...
                <TabsContent value="p2">
                  <PessoaForm
                    ...
                    bloquearEmailCpf
                    somenteLeitura={usuario.pessoaLogada !== 2}
                    onSave={async (dto) => {
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            required
            disabled={bloquearEmailCpf || somenteLeitura}
            readOnly={bloquearEmailCpf || somenteLeitura}
            className="h-11 rounded-xl"
          />
          {bloquearEmailCpf && (
...
function ListaPublicaCard() {
  ...
  const mut = useMutation({
    mutationFn: (novoStatus: boolean) => usuarioService.configurarListaPublica(novoStatus),
    onSuccess: async () => {
  ...
  return (
    <section className="rounded-2xl border bg-card shadow-soft overflow-hidden p-5">
      ...
      <div className="space-y-4">
        ...
        {usuario?.listaPublicaAtiva && usuario?.slugListaPublica && (
          <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                <Button 
                  variant="outline" 
                  className="w-full rounded-xl hover:bg-[#25D366]/10 hover:text-[#25D366] hover:border-[#25D366]/30 transition-colors" 
                  onClick={shareWhatsApp}
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4 mr-2 fill-current text-[#25D366]" xmlns="http://www.w3.org/2000/svg">
